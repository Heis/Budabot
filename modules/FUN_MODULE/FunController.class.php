...
class FunController {
	 ...
	 * Author: Derroylo (RK2)
	 *
	 * Some entries taken from a module developed by
	 * MysterF aka Floryn from Band of Brothers
	 * CROM originally for Bebot: http://bebot.shadow-realm.org/generic-custom-modules/homer-social-mod-for-bebot-0-6-2
	 */
